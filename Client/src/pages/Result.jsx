    ...
    <div className='mx-4 my-3 lg:mx-44 mt-14 min-h-[80vh]'>
        <div className='bg-white rounded-lg  px-8 py-6 drop-shadow-sm'>
          ...
          <div className='flex justify-center sm:justify-end items-center flex-wrap gap-4 mt-6  '>
             ...
             <a href="" className='px-8 py-2.5 text-white text-sm rounded-full bg-gradient-to-r from-blue-700 to-green-600  hover:scale-105 transition-all duration-700'>Download image</a>
          </div>
        </div>
    </div>
  )
