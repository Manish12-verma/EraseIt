      ...
      <div className="flex flex-wrap justify-center gap-6 text-left">
        {plans.map((plan, index) => (
          ...
          >
            ...
            <p className="mt-6">
              <span className="text-3xl font-md">${plan.price}</span>/{plan.credits} credits{" "}
            </p>
            <button className="w-full bg-gray-800 text-white r mt-8  text-sm rounded-md py-2.5 min-w-52">Purchase</button>
          </div>
        ))}
      </div>
    </div>
